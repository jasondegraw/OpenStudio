...
TEST_F(ModelFixture,AirflowNetworkSimulationControl_LoadsConvergenceToleranceValue_Quantity) {
  Model model;
  /*
...
TEST_F(ModelFixture,AirflowNetworkSimulationControl_TemperatureConvergenceToleranceValue_Quantity) {
  Model model;
  /*
  SimulationControl simulationControl = model.getUniqueModelObject<SimulationControl>();
...
TEST_F(ModelFixture,AirflowNetworkSimulationControl_LifeCycleCost) {
  Model model;
  /*
  SimulationControl simulationControl = model.getUniqueModelObject<SimulationControl>();
