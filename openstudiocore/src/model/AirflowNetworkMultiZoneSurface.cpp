...
PlanarSurface AirflowNetworkMultiZoneSurface_Impl::surface() const {
...
double AirflowNetworkMultiZoneSurface_Impl::windowDoorOpeningFactorOrCrackFactor() const {
  boost::optional<double> value = getDouble(OS_AirflowNetwork_MultiZoneSurfaceFields::Window_DoorOpeningFactororCrackFactor,true);
  OS_ASSERT(value);
  return value.get();
}

bool AirflowNetworkMultiZoneSurface_Impl::isWindowDoorOpeningFactorOrCrackFactorDefaulted() const {
  return isEmpty(OS_AirflowNetwork_MultiZoneSurfaceFields::Window_DoorOpeningFactororCrackFactor);
}
...
bool AirflowNetworkMultiZoneSurface_Impl::setSurface(const PlanarSurface& surfAndSubSurf) {
...
bool AirflowNetworkMultiZoneSurface_Impl::setWindowDoorOpeningFactorOrCrackFactor(double windowDoorOpeningFactorOrCrackFactor) {
  bool result = setDouble(OS_AirflowNetwork_MultiZoneSurfaceFields::Window_DoorOpeningFactororCrackFactor, windowDoorOpeningFactorOrCrackFactor);
  return result;
}

void AirflowNetworkMultiZoneSurface_Impl::resetWindowDoorOpeningFactorOrCrackFactor() {
  bool result = setString(OS_AirflowNetwork_MultiZoneSurfaceFields::Window_DoorOpeningFactororCrackFactor, "");
  OS_ASSERT(result);
}
...
boost::optional<PlanarSurface> AirflowNetworkMultiZoneSurface_Impl::optionalSurface() const {
  return getObject<ModelObject>().getModelObjectTarget<PlanarSurface>(OS_AirflowNetwork_MultiZoneSurfaceFields::SurfaceName);
}
...
PlanarSurface AirflowNetworkMultiZoneSurface::surface() const {
...
bool AirflowNetworkMultiZoneSurface::setSurface(const PlanarSurface& surfAndSubSurf) {
