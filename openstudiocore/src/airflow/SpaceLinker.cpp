...
std::vector<openstudio::model::Surface> SpaceLinker::getInteriorZoneSurfaces(openstudio::model::Model & model)
{
...
std::vector<openstudio::model::Surface> SpaceLinker::getExteriorZoneSurfaces(openstudio::model::Model & model)
{
  std::vector<openstudio::model::Surface> found;
  BOOST_FOREACH(openstudio::model::Surface surface, model.getConcreteModelObjects<openstudio::model::Surface>())
  {
