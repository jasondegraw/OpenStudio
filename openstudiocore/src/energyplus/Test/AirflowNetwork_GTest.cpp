...
TEST_F(EnergyPlusFixture,ForwardTranslator_AirflowNetworkSimulationControl_NoNetwork)
{
  ...
  workspace.save(toPath("./ForwardTranslator_AirflowNetwork.idf"), true);

  std::vector<WorkspaceObject> objects = workspace.getObjectsByType(IddObjectType::AirflowNetwork_SimulationControl);
